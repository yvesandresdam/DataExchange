...
// Posibles argumentos para ejecutar la aplicacion:
// 'dart run comarquescli provincies'
// 'dart run comarquescli comarques Alacant'
// 'dart run comarquescli comarques València'
// 'dart run comarquescli comarques Castelló'
// 'dart run comarquescli infocomarca {nombreComarca}'
...
displayComarcas(String provincia) async {
  String comarcasAnswer = await ComarquesService.getComarcas(provincia);

  print(comarcasAnswer);
/*
...
displayProvincesSync(String provincia) async {
  String provincies = await ComarquesService.getComarcas(provincia);
  print(provincies);
/*
